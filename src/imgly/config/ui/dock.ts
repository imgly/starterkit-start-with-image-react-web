 ...
 * This configuration is optimized for image-first workflows where users
 * start with an image and add overlays, text, stickers, and effects.
 *
...
export function setupDock(cesdk: CreativeEditorSDK): void {
  ...
  // #region Dock Order
  // Image-first workflow: No templates, focus on overlays and editing tools
